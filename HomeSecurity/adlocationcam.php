	    ...
	    <div class="col-lg-4">
          ...
          <form method ="post"   action="">
            ...
            <hr/>
              ...
              <a href="http://localhost/HomeSecurity/adlocationcamupdate.php"<button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
            </div>
            <!-- -----------------------------------BOTTON---------------------------------- -->
