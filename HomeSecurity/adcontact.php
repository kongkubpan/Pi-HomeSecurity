...
<style>
  ...
  {
    $info = getData();
    $search_query="SELECT * FROM `contact` WHERE `contact_no` = '$info[0]'";
  ...
  if(isset($_POST['insert'])){
    $info = getData();
    $insert_query="INSERT INTO `contact`(`contact_no`, `contact_name`, `contact_tel`, `mem_no`) VALUES ('$info[0]','$info[1]','$info[2]','$info[3]')";
    try{
  ...
  if(isset($_POST['delete'])){
    $info = getData();
    $delete_query = "DELETE FROM `contact` WHERE `contact_no` = '$info[0]'";
    try{
  ...
  if(isset($_POST['update'])){
    $info = getData();
    $update_query="UPDATE `contact` SET `contact_name`='$info[1]',`contact_tel`='$info[2]',`mem_no`='$info[3]' WHERE `contact_no` = '$info[0]'";
    try{
	    ...
	    <div class="col-lg-4">
          ...
          <form method ="post"   action="">
            ...
            <hr/>
              ...
              <a href="http://localhost/HomeSecurity/adcontactupdate.php"<button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
            </div>
            <!-- -----------------------------------BOTTON---------------------------------- -->
