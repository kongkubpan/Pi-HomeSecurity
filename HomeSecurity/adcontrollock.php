	    ...
	    <div class="col-lg-4">
          ...
          <form method ="post"   action="">
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-6">
                  <h1>MemberNo</h1>
                  <input type="text" name="e" class="form-control" value="<?php echo($e);?>" required>
                </div>
            </div>
            ...
            <hr/>
              ...
              <a href="http://localhost/HomeSecurity/adcontrollockupdate.php"<button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
            </div>
            <!-- -----------------------------------BOTTON---------------------------------- -->
